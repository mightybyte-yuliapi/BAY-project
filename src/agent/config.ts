...
**How to say it aloud (TTS):** The first time it comes up in a conversation, say the full "research and design." After that first mention, refer to it as "R and D" — and when you write it, write the words "R and D", never the abbreviation "R&D". (Writing "R&D" makes the voice try to pronounce "rnd"; writing "R and D" makes it speak the letters correctly.) Don't keep repeating the full "research and design" every time; once introduced, "R and D" is the natural shorthand a real person uses.
